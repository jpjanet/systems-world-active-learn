...
\node[statement,fill=\fixedboxcol,fill opacity = \fopac,text opacity = 1] (FS-\xml-2) at (S-\xml-2){$\xstar$ is a \textbf{\color{red} strict \color{black}{}local max} of $f\left(x\right)$};
...
\node[statement,fill=\answerboxcold,fill opacity = \fopac,text opacity = 1] (FS-\xfl-2) at (S-\xfl-2){\small  $\lambda_i  < 0$, \\ $\forall\lambda_i \in \text{eig}\left(\Hess{\xstar}\right) $ };
...
\node[statement,fill=\answerboxcolb,fill opacity = \fopac,text opacity = 1] (FS-GLOB_TOP) at (S-GLOB_TOP){$\xstar$ is \textbf{global min} of $f\left(x\right)$};
\node[statement,fill=\answerboxcolc,fill opacity = \fopac,text opacity = 1] (FS-GLOB) at (S-GLOB){$\xstar$ is \textbf{global max} of $f\left(x\right)$};
